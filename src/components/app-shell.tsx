              ...
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="sm" className="gap-2 cursor-pointer">
                  <Avatar className="size-7 ring-2 ring-primary/20">
                    ...
                    <AvatarFallback className="bg-gradient-to-br from-indigo-500 to-violet-600 text-white text-xs font-semibold">{abbr}</AvatarFallback>
                  </Avatar>
                  <span className="hidden sm:inline-block max-w-[160px] truncate text-sm">{fullName}</span>
                </Button>
              </DropdownMenuTrigger>
